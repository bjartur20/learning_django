...
def create_question(question_text, days):
    ...
    Args:
        question_text (str): Text for the question.
        days (int): When the question should be published.
    '''
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        response = self.client.get(url)
        print(response.content, past_question.question_text)
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        '''was_published_recently() returns False for question whose pubn_date
        is older than 1 day.
        '''
